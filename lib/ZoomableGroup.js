...
function (_Component) {
  ...
  function ZoomableGroup(props, context) {
    ...
    _this.state = {
      mouseX: (0, _utils.calculateMousePosition)("x", projection, zoom, 1),
      mouseY: (0, _utils.calculateMousePosition)("y", projection, zoom, 1),
      mouseXStart: 0,
      mouseYStart: 0,
      isPressed: false,
      resizeFactorX: 1,
  ...
  _createClass(ZoomableGroup, [{
    ...
    value: function componentWillReceiveProps(nextProps, nextContext) {
      ...
      this.setState({
        zoom: nextProps.zoom,
        mouseX: centerChanged ? (0, _utils.calculateMousePosition)("x", nextContext.projection, nextProps, nextProps.zoom, resizeFactorX) : mouseX * zoomFactor,
        mouseY: centerChanged ? (0, _utils.calculateMousePosition)("y", nextContext.projection, nextProps, nextProps.zoom, resizeFactorY) : mouseY * zoomFactor
      });
    }
  }, {
    key: "handleResize",
