...
function (_Component) {
  ...
  _createClass(Geography, [{
    ...
    value: function render() {
      ...
      var projection = this.props.projection || this.context.projection;
      ...
      var excludeProps = ["geography", "round", "cacheId", "precision", "tabable", "style", "onClick", "onMouseEnter", "onMouseMove", "onMouseLeave", "onMouseDown", "onMouseUp", "onFocus", "onBlur"];
...
Geography.contextType = _utils.MapContext;
