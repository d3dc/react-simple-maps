...
function (_Component) {
  ...
  function Geographies(props, context) {
    var _this;

    _classCallCheck(this, Geographies);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(Geographies).call(this, props, context));
    _this.state = {
...
Geographies.contextType = _utils.MapContext;
